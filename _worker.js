...
async function searchInterface() {
	...
	<body>
		<a href="https://baidu.com" target="_blank" class="github-corner" aria-label="View source on Github">
		...
		<div class="container">
			...
			<h1 class="title">欢迎baidu.com</h1>
			<p class="subtitle">查找baidu.com</p>
			<div class="search-container">
				<div type="text" id="search-input" >baidu.com</div>
			</div>
		</div>
		<script>
